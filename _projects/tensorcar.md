---
title: TensorCar
summary: Teaching a simulated car to drive a track with Q-learning in TensorFlow. This was the culmination of several months worth of trying to teach myself machine learning.
category: ml
date: 2020-04-13
period: "2020"
...
When I learned that Google's DeepMind could beat a human at Go, it felt like magic to me. I spent the next several months trying to teach myself machine learning. I don't include all of those attempts here, from digit recognition to convolutional neural networks, but the culmination of my learning was to try and build my own Q-learning reward based network. That's what I tried to do here!

## How it works

First, I built a simple racing game in python that I could train a model to beat. Once I got the controls working for myself, it came time to train a model.
...
For rewards, I made a series of gates that it had to past, as well as a punishment for hitting the walls and for taking too much time. The network itself were two fully connected layers with 50 nodes and ReLU activation.
